...
| 微調腳本 | 中文輸入法 |
| -------- | ---------- |
| [fcitx5-chewing 安裝設定腳本](https://github.com/samwhelp/endeavouros-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-chewing) | 新酷音輸入法 |
...
> 可以參考我的「[package-list.txt](https://github.com/samwhelp/endeavouros-adjustment/blob/main/prototype/main/im-config/fcitx5/fcitx5-chewing/package-list.txt)」。
...
這個設定會被儲存在「[~/.config/fcitx5/profile](https://github.com/samwhelp/endeavouros-adjustment/blob/main/prototype/main/im-config/fcitx5/fcitx5-chewing/asset/overlay/etc/skel/.config/fcitx5/profile#L15-L19)」這個檔案。
